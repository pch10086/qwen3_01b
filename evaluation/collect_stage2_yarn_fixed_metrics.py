...
RUNS = {
    ...
    "rope_yarn_old": BASE / "outputs/stage2_kv4k_rope_yarn_minikv_digit8_len2k4k_pos5_s100/summary.csv",
    "rope_yarn_fixed": BASE / "outputs/stage2_kv4k_rope_yarn_fixed_minikv_digit8_len2k4k_pos5_s100/summary.csv",
}
...
def main() -> None:
    ...
    out = BASE / "outputs/stage2_kv4k_rope_compare_key_metrics_with_yarn_fixed.csv"
